...
<footer class="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
	...
	<div class="w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 sm:grid-cols-3">
		...
		<div class="flex flex-col space-y-4">
			<a sveltekit:prefetch href="/users" class="{linkClass}" aria-label="{'Footer tags link'}">Users</a>
			<a sveltekit:prefetch href="/settings" class="{linkClass}" aria-label="{'Footer tags link'}">Settings</a>
